...
class Dashboard extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($course_list as $item_course_list) :
            ...
            if ($courseCompletedStatus == 1) :
                ...
                //$db = \Config\Database::connect(); //Codeigniter 4 db connection
                $db = DB::connection(); //laravel db connection
    ...
    function courseEnrollCheck(Request $request)
    {
    ...
    function courseEnrollSave(Request $request)
    {
    ...
    function courseEnrollDropout(Request $request)
    {
    ...
    public function courseDetail($courseSlug, $courseContentId = null)
    { // WARNING -> enroll_id olmamalı!!
        ...
        if (!$courseId) : die("Beklenmedik bir hata meydana geldi. Lütfen yöneticinize başvurun.");
        endif;
        ...
        $person_enroll =  $courseEnrollModel->Select("id")
            ...
            ->first();
        if (!$person_enroll) : die("Erişim yetkiniz yoktur.");
        endif;
    ...
    public function courseCompleted(Request $request)
    {
        ...
        $getCurrentTime = $request->get('getCurrentTime');
        $content_type   = $request->get('courseType');
        $videoPercent   = $request->get('videoPercent');
    ...
    function courseContinueLinkControl(Request $request)
    {
        ...
        $content_id = $request->get('content');
        $indis = array();
    ...
    function courseContinueLinkNextEpisodes(Request $request)
    {
    ...
    function courseRate(Request $request)
    {
    ...
    public function courseRateList(Request $request)
    {
